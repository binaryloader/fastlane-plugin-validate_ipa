...
Gem::Specification.new do |spec|
  ...
  spec.author        = 'binaryloader'
  spec.email         = '152517454+binaryloader@users.noreply.github.com'

  spec.summary       = 'Validate the IPA using altool.'
  spec.homepage      = "https://github.com/binaryloader/fastlane-plugin-validate_ipa"
  spec.license       = "MIT"
